...
function isEdValidXY(Fp2, CURVE, x, y) {
  const x2 = Fp2.sqr(x);
  const y2 = Fp2.sqr(y);
  const left2 = Fp2.add(Fp2.mul(CURVE.a, x2), y2);
  const right = Fp2.add(Fp2.ONE, Fp2.mul(CURVE.d, Fp2.mul(x2, y2)));
  return Fp2.eql(left2, right);
}
  ...
  function pop2(heap) {
    ...
    if (last !== first) {
      ...
      a: for (var index2 = 0, length = heap.length, halfLength = length >>> 1; index2 < halfLength; ) {
        var leftIndex = 2 * (index2 + 1) - 1, left2 = heap[leftIndex], rightIndex = leftIndex + 1, right = heap[rightIndex];
        if (0 > compare2(left2, last))
          rightIndex < length && 0 > compare2(right, left2) ? (heap[index2] = right, heap[rightIndex] = last, index2 = rightIndex) : (heap[index2] = left2, heap[leftIndex] = last, index2 = leftIndex);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3.5 border-b border-gray-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-5 h-5 text-purple-600" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-extrabold text-gray-900", children: "My Cart" }),
                items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500", children: [
                  totalItems,
                  " item",
                  totalItems !== 1 ? "s" : ""
                ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5 text-gray-700" })
              }
            )
          ] }),
          items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-3 px-3 py-2 rounded-xl flex items-center gap-2 bg-green-50 border border-green-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 flex-shrink-0 text-green-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-green-600", children: [
              "⚡ Delivery in ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-4 py-3", children: items.length === 0 ? (
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full flex items-center justify-center text-5xl bg-purple-50", children: "🛒" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-extrabold text-gray-900", children: "Your cart is empty" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1.5 text-gray-500", children: "Add items to get started" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-xl flex-shrink-0 overflow-hidden flex items-center justify-center bg-gray-50 border border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold line-clamp-2 leading-snug text-gray-900", children: item.product.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 text-gray-400", children: item.product.weight }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-extrabold text-gray-900", children: [
                        "₹",
                        item.product.price
                      ] }),
                      item.product.originalPrice > item.product.price && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs line-through text-gray-400", children: [
                        "₹",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-2 flex-shrink-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center rounded-xl overflow-hidden border-2 border-purple-600", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 text-center text-sm font-extrabold text-purple-600", children: item.quantity }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
          ...
          items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-gray-200 bg-gray-50", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "w-4 h-4 flex-shrink-0 text-purple-600" }),
                    couponApplied ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-green-600", children: "ZEPTO5 applied — 5% off!" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-3 pb-2 space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-extrabold uppercase tracking-wide text-gray-500", children: "Bill Details" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "Item Total" }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "Delivery Fee" }),
                      isFreeDelivery ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs line-through text-gray-400", children: [
                          "₹",
                          DELIVERY_FEE
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-green-600", children: "FREE" })
                      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-gray-900", children: [
                        "₹",
                        DELIVERY_FEE
                      ] })
                    ] }),
                    !isFreeDelivery && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-xs bg-yellow-50 text-amber-800", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: "Platform Fee" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-gray-900", children: [
                        "₹",
                        PLATFORM_FEE
                      ] })
                    ...
                    couponApplied && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600", children: "Coupon Discount" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between pt-2 mt-1 border-t border-gray-200 font-extrabold text-base text-gray-900", children: [
...
const SOCIAL_LINKS = [
  { label: "Twitter", icon, href: "#", color: "#1DA1F2" },
  { label: "Instagram", icon, href: "#", color: "#E1306C" },
  { label: "Facebook", icon, href: "#", color: "#1877F2" },
  { label: "LinkedIn", icon, href: "#", color: "#0A66C2" }
];
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        "data-ocid": "header",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-3 md:px-5 h-16 flex items-center gap-3 md:gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: "/",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                "data-ocid": "cart-btn",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-6 h-6 text-primary-foreground" }),
                  totalItems > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 bg-accent text-accent-foreground text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center", children: totalItems })
                ]
              }
            )
          ] })
...
function ProductSection({
  ...
  const scrollLeft = () => {
    var _a2;
    (_a2 = scrollRef.current) == null ? void 0 : _a2.scrollBy({ left: -600, behavior: "smooth" });
  };
  const scrollRight = () => {
    var _a2;
    (_a2 = scrollRef.current) == null ? void 0 : _a2.scrollBy({ left, behavior: "smooth" });
  };
  const handleScroll = () => {
